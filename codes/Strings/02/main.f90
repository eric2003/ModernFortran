...
!Example
!The following example uses the date_and_time function to give the date and time string. 
!We use extent specifiers to extract the year, date, month, hour, minutes and second information separately.
